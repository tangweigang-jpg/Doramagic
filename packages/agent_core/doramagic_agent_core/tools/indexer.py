...
from doramagic_agent_core.core.tool_registry import ToolDef
...
# ---------------------------------------------------------------------------
# Iteration scale factor (shared by both blueprint and constraint pipelines)
# ---------------------------------------------------------------------------


def compute_iter_scale(file_count: int) -> float:
